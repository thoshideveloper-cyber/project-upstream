...
/**
 * A bordered section of a page — white, one hairline, no shadow. Use it to group a
 * block of related content, never to float a single number: a card per metric is the
 * dashboard cliché this product avoids.
 */
function Card({
  className,
  size = "default",
